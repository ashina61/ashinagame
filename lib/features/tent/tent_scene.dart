  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const Text('Maliyet', style: AppTextStyles.section),
        ...
        const SizedBox(height: 8),
        const Text('Şartlar', style: AppTextStyles.section),
        const SizedBox(height: 4),
        for (final req in target.requirements)
          _RequirementLine(text: req, ok: _requirementMet(state, req)),
        const SizedBox(height: 8),
        const Text('Kazanılacak bonuslar', style: AppTextStyles.section),
        const SizedBox(height: 4),
