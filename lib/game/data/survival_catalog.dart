...
class SurvivalCatalog {
  ...
  static const actions = <SurvivalActionDef>[
    SurvivalActionDef(
      ...
      thirstCost: 6,
      cooldownDays: 1,
      outputs: {ResourceType.leather: 2},
      foodOutputs: {'raw_meat': 2},
      hint: 'Avlak bugün sessizse kapan kur.',
    ),
    SurvivalActionDef(
      id: 'fish',
      category: 'Hayatta Kalma',
    ...
    SurvivalActionDef(
      ...
      hungerCost: 4,
      thirstCost: 3,
      foodOutputs: {'root_vegetable': 2, 'wild_herb': 1},
    ),
    SurvivalActionDef(
      id: 'find_water',
      category: 'Hayatta Kalma',
    ...
    SurvivalActionDef(
      ...
      hungerCost: 2,
      thirstCost: 2,
      outputs: {ResourceType.wood: -4, ResourceType.morale: 3},
    ),
    SurvivalActionDef(
      id: 'set_trap',
      category: 'Hayatta Kalma',
    ...
    SurvivalActionDef(
      ...
      hungerCost: 1,
      thirstCost: 1,
      outputs: {ResourceType.wood: -2},
      foodInputs: {'raw_meat': 1},
      foodOutputs: {'cooked_meat': 1},
    ),
    SurvivalActionDef(
      id: 'dry_meat',
      category: 'Yiyecek Hazırlama',
      ...
      thirstCost: 2,
      cooldownDays: 1,
      outputs: {ResourceType.wood: -3},
      foodInputs: {'raw_meat': 1, 'salt': 1},
      foodOutputs: {'dried_meat': 1},
    ),
    SurvivalActionDef(
      id: 'cook_fish',
      category: 'Yiyecek Hazırlama',
      ...
      hungerCost: 1,
      thirstCost: 1,
      outputs: {ResourceType.wood: -1},
      foodInputs: {'fish': 1},
      foodOutputs: {'cooked_fish': 1},
    ),
    SurvivalActionDef(
      id: 'make_soup',
      category: 'Yiyecek Hazırlama',
      ...
      thirstCost: 1,
      outputs: {ResourceType.wood: -2},
      foodInputs: {'root_vegetable': 1, 'water_skin': 1},
      foodOutputs: {'soup': 1},
    ),
    SurvivalActionDef(
      id: 'archery_drill',
      ...
      hungerCost: 4,
      thirstCost: 5,
      outputs: {ResourceType.reputation: 1},
    ),
    SurvivalActionDef(
      id: 'riding_drill',
      category: 'Talim',
      name: 'At binme talimi',
      fatigueCost: 9,
      hungerCost: 4,
      thirstCost: 5,
      outputs: {ResourceType.horse: 0},
    ),
    SurvivalActionDef(
      id: 'elder_lesson',
      category: 'Sosyal',
      name: 'Yaşlılardan öğüt al',
      fatigueCost: 2,
      hungerCost: 1,
      thirstCost: 1,
      outputs: {ResourceType.reputation: 1},
    ...
    SurvivalActionDef(
      id: 'river_scout',
      category: 'Keşif',
      name: 'Irmak kıyısına in',
      fatigueCost: 7,
      hungerCost: 3,
      thirstCost: 3,
      foodOutputs: {'fish': 1, 'water_skin': 1},
    ),
    SurvivalActionDef(
      id: 'search_inscription',
      category: 'Keşif',
      name: 'Eski yazıt ara',
      fatigueCost: 9,
      hungerCost: 4,
      thirstCost: 4,
      cooldownDays: 2,
      outputs: {ResourceType.reputation: 2},
    ),
    SurvivalActionDef(
      id: 'market_road',
      category: 'Keşif',
      name: 'Pazar yoluna bak',
      fatigueCost: 7,
      hungerCost: 3,
      thirstCost: 4,
      outputs: {ResourceType.gold: 3},
    ),
    SurvivalActionDef(
      id: 'make_bow',
      category: 'Üretim / Zanaat',
      name: 'Basit yay yap',
      fatigueCost: 8,
      hungerCost: 3,
      thirstCost: 3,
    ...
    SurvivalActionDef(
      id: 'tent_work',
      category: 'Oba Hazırlığı',
      name: 'Çadır dikimi',
      fatigueCost: 8,
      hungerCost: 4,
      thirstCost: 4,
      outputs: {ResourceType.wood: -4, ResourceType.morale: 2},
    ),
    SurvivalActionDef(
      id: 'prepare_storage',
      category: 'Oba Hazırlığı',
      name: 'Depo alanı hazırla',
      fatigueCost: 7,
      hungerCost: 3,
      thirstCost: 3,
      outputs: {
  ...
  static const opportunities = <OpportunityDef>[
    OpportunityDef(
      'fish_river',
      'su',
      'Irmak kıyısında balık bol.',
      'Bugün balık tutmak daha güvenli.',
    ),
    OpportunityDef(
      'salt_merchant',
      'ticaret',
      'Pazar yolunda tuz taşıyan tüccar görüldü.',
      'Tuz kışlık yiyeceği korur.',
    ),
    OpportunityDef(
      'stag_tracks',
      'av',
      'Avlakta büyük geyik izi var.',
      'Avlan ödülü artabilir ama yorucudur.',
    ),
    OpportunityDef(
      'horse_cough',
      'at',
      'Atlardan biri hasta görünüyor.',
      'Bakım gecikirse yolculuk zayıflar.',
    ),
    OpportunityDef(
      'cold_night',
      'hava',
      'Gece soğuk olacak, odun hazırla.',
      'Sıcaklık düşerse sağlık etkilenir.',
    ),
    OpportunityDef(
      'old_inscription',
      'keşif',
      'Yaşlı kadın eski yazıttan söz etti.',
      'Eski yazıt zinciri ilerleyebilir.',
    ),
    OpportunityDef(
      'youth_training',
      'sosyal',
      'Gençler ok talimi istiyor.',
      'Talim moral ve itibar getirir.',
    ),
    OpportunityDef(
      'spoiling_meat',
      'hastalık',
      'Depodaki çiğ et bozulmak üzere.',
      'Pişir veya kurut.',
    ),
  ];
  ...
  static const bigGoals = <BigGoalDef>[
    BigGoalDef(
      'survive_week',
      '7 gün hayatta kal',
      'Açlık ve susuzluğu dengede tut.',
      14,
    ),
    BigGoalDef(
      'first_dried_meat',
      'İlk kurutulmuş eti hazırla',
      'Kış için uzun ömürlü yiyecek stokla.',
      14,
    ),
    BigGoalDef(
      'tent_lv2',
      'Çadırını Lv2 yap',
      'Sağlam Çadır erken kış güvenliği sağlar.',
      14,
    ),
    BigGoalDef(
      'first_horse',
      'İlk atı satın al',
      'Pazar yolu ve at pazarıyla ilgilen.',
      16,
    ),
    BigGoalDef(
      'tent_lv3',
      'Çadırını Lv3 yap',
      'Oba Çadırı oba kurma yolunda ana şarttır.',
      16,
    ),
    BigGoalDef(
      'found_oba',
      'Oba kur',
      'Yoldaş, itibar, toprak ve güçlü bağ şartlarını tamamla.',
      18,
    ),
    BigGoalDef(
      'first_campaign',
      'İlk sefer hazırlığı',
      'Ekipman, at ve yoldaş gücü topla.',
      21,
    ),
  ];
  ...
  static const recipes = <ProjectRecipeDef>[
    ...
    ProjectRecipeDef(
      ...
      'Basit Yay',
      2,
      {ResourceType.wood: 12, ResourceType.leather: 3},
      {},
      'hunting_bow',
    ),
    ProjectRecipeDef(
      ...
      'Kompozit Yay',
      4,
      {ResourceType.wood: 25, ResourceType.leather: 10, ResourceType.iron: 2},
      {},
      'composite_bow',
    ),
    ProjectRecipeDef(
      ...
      'Deri Zırh',
      3,
      {ResourceType.leather: 18, ResourceType.iron: 2},
      {},
      'leather_armor',
    ),
    ProjectRecipeDef(
      ...
      'At Koşumu',
      2,
      {ResourceType.leather: 12, ResourceType.iron: 3},
      {},
      'horse_harness',
    ),
    ProjectRecipeDef(
      ...
      'Gözcü Kulesi',
      5,
      {ResourceType.wood: 60, ResourceType.stone: 20},
      {},
      'watchtower',
    ),
  ];
